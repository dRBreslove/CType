...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_18121 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_18121(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_18122 = (function (runtime,key,spec){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_18122(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_18123 = (function (runtime,key){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_18123(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_18124 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_18124(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_18127 = (function (runtime,input,callback){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_18127(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_18128 = (function (runtime,code,success,fail){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_18128(runtime,code,success,fail);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__18119,callback){
var map__18120 = p__18119;
var map__18120__$1 = cljs.core.__destructure_map(map__18120);
var input = map__18120__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18120__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18120__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
