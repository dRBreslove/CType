...
var o9321 = temp__5802__auto__;
var temp__5802__auto____$1 = (o9321["core"]);
if(cljs.core.truth_(temp__5802__auto____$1)){
var o9322 = temp__5802__auto____$1;
return (o9322["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__8920__auto__ = f;
return (o__8920__auto__["toString"]).call(o__8920__auto__);
} else {
return "";
}
}catch (e9330){var _ = e9330;
return "";
}});
...
try{var o__8920__auto___9637 = t;
(o__8920__auto___9637["cljs$lang$ctorPrWriter"]).call(o__8920__auto___9637,t,writer);
}catch (e9338){var __9638 = e9338;
}
...
var char_code = (function (){var o__8920__auto__ = (new String(char$));
return (o__8920__auto__["charCodeAt"]).call(o__8920__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__8920__auto__ = String;
return (o__8920__auto__["fromCharCode"]).call(o__8920__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__9348 = num_code;
switch (G__9348) {
case (1):
return (185);
...
var o__8920__auto__ = String;
return (o__8920__auto__["fromCharCode"]).call(o__8920__auto__,superscript_code);
});
/**
...
}catch (e9374){var _e__8930__auto__ = e9374;
return false;
}})())){
...
var vec__9391 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9391,(0),null);
...
var len__5726__auto___9652 = arguments.length;
var i__5727__auto___9653 = (0);
while(true){
if((i__5727__auto___9653 < len__5726__auto___9652)){
args__5732__auto__.push((arguments[i__5727__auto___9653]));

var G__9655 = (i__5727__auto___9653 + (1));
i__5727__auto___9653 = G__9655;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__9427){
var vec__9428 = p__9427;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9428,(0),null);
...
var G__9659 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__9660 = cljs.core.butlast(remaining_tokens);
name_tokens = G__9659;
remaining_tokens = G__9660;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq9417){
var G__9418 = cljs.core.first(seq9417);
var seq9417__$1 = cljs.core.next(seq9417);
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__9418,seq9417__$1);
}));
...
var vec__9434 = cljs.core.split_with((function (p1__9432_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__9432_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9434,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9434,(1),null);
...
var vec__9440 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9440,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9440,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__9669 = cljs.core.rest(remaining_tokens);
var G__9670 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__9669;
name_tokens = G__9670;
continue;
} else {
...
var vec__9465 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9465,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9465,(1),null);
var vec__9468 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9468,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9468,(1),null);
var vec__9471 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9471,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9471,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9471,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9471,(3),null);
...
var vec__9476 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9476,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9476,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9476,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9476,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9476,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9476,(5),null);
...
if(cljs.core.truth_(temp__5802__auto__)){
var vec__9487 = temp__5802__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9487,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9487,(1),null);
var vec__9493 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9493,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9493,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__9508 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__9508) : devtools.munging.parse_fn_info_deep.call(null, G__9508));
})()));
}
} else {
return fn_info;
...
var G__9686 = (arity + (1));
var G__9687 = (function (){var temp__5802__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5802__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__9521){
var vec__9522 = p__9521;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9522,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9522,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__9534_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__9534_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__9535_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__9535_SHARP_);
}),sorted_infos);
...
var args__5732__auto__ = [];
var len__5726__auto___9700 = arguments.length;
var i__5727__auto___9701 = (0);
while(true){
if((i__5727__auto___9701 < len__5726__auto___9700)){
args__5732__auto__.push((arguments[i__5727__auto___9701]));

var G__9702 = (i__5727__auto___9701 + (1));
i__5727__auto___9701 = G__9702;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__9552){
var vec__9553 = p__9552;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9553,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq9540){
var G__9541 = cljs.core.first(seq9540);
var seq9540__$1 = cljs.core.next(seq9540);
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__9541,seq9540__$1);
}));
...
var map__9582 = options;
var map__9582__$1 = cljs.core.__destructure_map(map__9582);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__9582__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__9582__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__9582__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__9582__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__9583 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9583,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9583,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9583,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9583,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9583,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9583,(5),null);
...
var o__8920__auto__ = f;
return (o__8920__auto__["getBasis"]).call(o__8920__auto__);
});
/**
...
}catch (e9590){var _e__8930__auto__ = e9590;
...
var G__9716 = (obj[cljs.core.first(path)]);
var G__9717 = cljs.core.rest(path);
obj = G__9716;
path = G__9717;
continue;
} else {
...
var _STAR_ = (function (accum,p__9614){
var vec__9615 = p__9614;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9615,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9615,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__9618){
var vec__9619 = p__9618;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9619,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9619,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9619,(2),null);
...
var post_process = (function (p__9627){
var vec__9628 = p__9627;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9628,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9628,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__9626_SHARP_){
return (obj[cljs.core.first(p1__9626_SHARP_)]);
}),sorted_matches);
