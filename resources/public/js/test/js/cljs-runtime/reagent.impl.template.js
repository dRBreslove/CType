...
var G__7537 = o;
reagent.impl.template.goog$module$goog$object.set(G__7537,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null, v)));
...
return (function() { 
var G__7571__delegate = function (args){
...
var G__7539 = o;
reagent.impl.template.goog$module$goog$object.set(G__7539,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
var args = null;
if (arguments.length > 0) {
var G__7585__i = 0, G__7585__a = new Array(arguments.length -  0);
while (G__7585__i < G__7585__a.length) {G__7585__a[G__7585__i] = arguments[G__7585__i + 0]; ++G__7585__i;}
  args = new cljs.core.IndexedSeq(G__7585__a,0,null);
} 
...
var G__7540 = props;
var G__7540__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__7540,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__7540);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__7540__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5002__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__7541 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__7541,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__7541;
}
})(),id_class);
...
var G__7542 = (cljs.core.count(argv) - first_child);
switch (G__7542) {
case (0):
...
var vec__7543 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__7543,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__7543,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__7543,(2),null);
...
var temp__5808__auto___7593 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___7593 == null)){
} else {
var key_7594 = temp__5808__auto___7593;
(jsprops.key = key_7594);
}
...
var temp__5808__auto___7596 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___7596 == null)){
} else {
var key_7599 = temp__5808__auto___7596;
(jsprops.key = key_7599);
}
...
var temp__5808__auto___7602 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5808__auto___7602 == null)){
} else {
var key_7603 = temp__5808__auto___7602;
(jsprops.key = key_7603);
}
...
var temp__5808__auto___7610 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___7610 == null)){
} else {
var key_7611 = temp__5808__auto___7610;
(jsprops.key = key_7611);
}
...
var temp__5808__auto___7612 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___7612 == null)){
} else {
var key_7613 = temp__5808__auto___7612;
(jsprops.key = key_7613);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__7546_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__7546_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__7553 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__7553,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__7553,(1),null);
...
break;
default:
var G__7615 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__7616 = compiler;
v = G__7615;
compiler = G__7616;
continue;
...
*/
reagent.impl.template.t_reagent$impl$template7568 = (function (opts,id,fn_to_element,parse_fn,meta7569){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template7568.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_7570,meta7569__$1){
var self__ = this;
var _7570__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template7568(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta7569__$1));
}));

(reagent.impl.template.t_reagent$impl$template7568.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_7570){
var self__ = this;
var _7570__$1 = this;
return self__.meta7569;
}));

(reagent.impl.template.t_reagent$impl$template7568.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template7568.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template7568.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template7568.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template7568.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template7568.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta7569","meta7569",347405719,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template7568.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template7568.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template7568");

(reagent.impl.template.t_reagent$impl$template7568.cljs$lang$ctorPrWriter = (function (this__5287__auto__,writer__5288__auto__,opt__5289__auto__){
return cljs.core._write(writer__5288__auto__,"reagent.impl.template/t_reagent$impl$template7568");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template7568.
 */
reagent.impl.template.__GT_t_reagent$impl$template7568 = (function reagent$impl$template$__GT_t_reagent$impl$template7568(opts,id,fn_to_element,parse_fn,meta7569){
return (new reagent.impl.template.t_reagent$impl$template7568(opts,id,fn_to_element,parse_fn,meta7569));
});
...
return (new reagent.impl.template.t_reagent$impl$template7568(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
