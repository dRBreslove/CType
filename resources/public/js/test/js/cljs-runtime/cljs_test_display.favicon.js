...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__12494_SHARP_){
return html_coll.item(p1__12494_SHARP_);
...
return cljs.core.some((function (p1__12496_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("icon",p1__12496_SHARP_);
...
var ctx_12504 = cvs.getContext("2d");
(ctx_12504.fillStyle = color);

ctx_12504.fillRect((0),(0),size,size);
