...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_16045 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_16045(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_16056 = (function (port,val,fn1_handler){
var x__5350__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_16056(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_16057 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_16057(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_16058 = (function (chan){
var x__5350__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_16058(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_16062 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_16062(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_16063 = (function (h){
var x__5350__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_16063(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_16067 = (function (h){
var x__5350__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_16067(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_16072 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_16072(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_16076 = (function (b){
var x__5350__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_16076(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_16077 = (function (b,itm){
var x__5350__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_16077(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_16078 = (function (b){
var x__5350__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_16078(b);
}
});
