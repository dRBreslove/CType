...
var G__23470 = o;
reagent.impl.template.goog$module$goog$object.set(G__23470,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__23488__delegate = function (args){
...
while (G__23489__i < G__23489__a.length) {G__23489__a[G__23489__i] = arguments[G__23489__i + 0]; ++G__23489__i;}
  args = new cljs.core.IndexedSeq(G__23489__a,0,null);
} 
return G__23488__delegate.call(this,args);};
G__23488.cljs$lang$maxFixedArity = 0;
G__23488.cljs$lang$applyTo = (function (arglist__23490){
var args = cljs.core.seq(arglist__23490);
return G__23488__delegate(args);
});
...
var G__23471 = o;
reagent.impl.template.goog$module$goog$object.set(G__23471,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__23491__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__23491 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__23492__i = 0, G__23492__a = new Array(arguments.length -  0);
while (G__23492__i < G__23492__a.length) {G__23492__a[G__23492__i] = arguments[G__23492__i + 0]; ++G__23492__i;}
  args = new cljs.core.IndexedSeq(G__23492__a,0,null);
} 
return G__23491__delegate.call(this,args);};
G__23491.cljs$lang$maxFixedArity = 0;
G__23491.cljs$lang$applyTo = (function (arglist__23493){
var args = cljs.core.seq(arglist__23493);
return G__23491__delegate(args);
});
...
var G__23472 = props;
var G__23472__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__23472,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__23472);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__23472__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5002__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__23473 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__23473,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__23473;
}
})(),id_class);
...
var G__23474 = (cljs.core.count(argv) - first_child);
switch (G__23474) {
case (0):
...
var vec__23475 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23475,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23475,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23475,(2),null);
...
var temp__5808__auto___23501 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___23501 == null)){
} else {
var key_23502 = temp__5808__auto___23501;
(jsprops.key = key_23502);
}
...
var temp__5808__auto___23503 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___23503 == null)){
} else {
var key_23504 = temp__5808__auto___23503;
(jsprops.key = key_23504);
}
...
var temp__5808__auto___23509 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5808__auto___23509 == null)){
} else {
var key_23510 = temp__5808__auto___23509;
(jsprops.key = key_23510);
}
...
var temp__5808__auto___23516 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___23516 == null)){
} else {
var key_23518 = temp__5808__auto___23516;
(jsprops.key = key_23518);
}
...
var temp__5808__auto___23519 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___23519 == null)){
} else {
var key_23520 = temp__5808__auto___23519;
(jsprops.key = key_23520);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__23478_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__23478_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__23479 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23479,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23479,(1),null);
...
break;
default:
var G__23522 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__23523 = compiler;
v = G__23522;
compiler = G__23523;
continue;
...
*/
reagent.impl.template.t_reagent$impl$template23485 = (function (opts,id,fn_to_element,parse_fn,meta23486){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template23485.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_23487,meta23486__$1){
var self__ = this;
var _23487__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template23485(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta23486__$1));
}));

(reagent.impl.template.t_reagent$impl$template23485.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_23487){
var self__ = this;
var _23487__$1 = this;
return self__.meta23486;
}));

(reagent.impl.template.t_reagent$impl$template23485.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template23485.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template23485.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template23485.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template23485.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template23485.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta23486","meta23486",1079854477,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template23485.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template23485.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template23485");

(reagent.impl.template.t_reagent$impl$template23485.cljs$lang$ctorPrWriter = (function (this__5287__auto__,writer__5288__auto__,opt__5289__auto__){
return cljs.core._write(writer__5288__auto__,"reagent.impl.template/t_reagent$impl$template23485");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template23485.
 */
reagent.impl.template.__GT_t_reagent$impl$template23485 = (function reagent$impl$template$__GT_t_reagent$impl$template23485(opts,id,fn_to_element,parse_fn,meta23486){
return (new reagent.impl.template.t_reagent$impl$template23485(opts,id,fn_to_element,parse_fn,meta23486));
});
...
return (new reagent.impl.template.t_reagent$impl$template23485(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
