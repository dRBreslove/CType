...
var G__12197 = o;
reagent.impl.template.goog$module$goog$object.set(G__12197,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null, v)));
...
return (function() { 
var G__12215__delegate = function (args){
...
while (G__12216__i < G__12216__a.length) {G__12216__a[G__12216__i] = arguments[G__12216__i + 0]; ++G__12216__i;}
  args = new cljs.core.IndexedSeq(G__12216__a,0,null);
} 
...
var G__12198 = o;
reagent.impl.template.goog$module$goog$object.set(G__12198,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__12218__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__12218 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__12219__i = 0, G__12219__a = new Array(arguments.length -  0);
while (G__12219__i < G__12219__a.length) {G__12219__a[G__12219__i] = arguments[G__12219__i + 0]; ++G__12219__i;}
  args = new cljs.core.IndexedSeq(G__12219__a,0,null);
} 
return G__12218__delegate.call(this,args);};
G__12218.cljs$lang$maxFixedArity = 0;
G__12218.cljs$lang$applyTo = (function (arglist__12220){
var args = cljs.core.seq(arglist__12220);
return G__12218__delegate(args);
});
...
var G__12199 = props;
var G__12199__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__12199,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__12199);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__12199__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5002__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__12200 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__12200,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__12200;
}
})(),id_class);
...
var G__12201 = (cljs.core.count(argv) - first_child);
switch (G__12201) {
case (0):
...
var vec__12202 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12202,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12202,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12202,(2),null);
...
var temp__5808__auto___12222 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___12222 == null)){
} else {
var key_12223 = temp__5808__auto___12222;
(jsprops.key = key_12223);
}
...
var temp__5808__auto___12224 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___12224 == null)){
} else {
var key_12225 = temp__5808__auto___12224;
(jsprops.key = key_12225);
}
...
var temp__5808__auto___12226 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5808__auto___12226 == null)){
} else {
var key_12227 = temp__5808__auto___12226;
(jsprops.key = key_12227);
}
...
var temp__5808__auto___12233 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___12233 == null)){
} else {
var key_12234 = temp__5808__auto___12233;
(jsprops.key = key_12234);
}
...
var temp__5808__auto___12235 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___12235 == null)){
} else {
var key_12236 = temp__5808__auto___12235;
(jsprops.key = key_12236);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__12205_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__12205_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__12206 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12206,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12206,(1),null);
...
break;
default:
var G__12240 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__12241 = compiler;
v = G__12240;
compiler = G__12241;
continue;
...
*/
reagent.impl.template.t_reagent$impl$template12212 = (function (opts,id,fn_to_element,parse_fn,meta12213){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template12212.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_12214,meta12213__$1){
var self__ = this;
var _12214__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template12212(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta12213__$1));
}));

(reagent.impl.template.t_reagent$impl$template12212.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_12214){
var self__ = this;
var _12214__$1 = this;
return self__.meta12213;
}));

(reagent.impl.template.t_reagent$impl$template12212.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template12212.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template12212.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template12212.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template12212.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template12212.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta12213","meta12213",-2011683987,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template12212.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template12212.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template12212");

(reagent.impl.template.t_reagent$impl$template12212.cljs$lang$ctorPrWriter = (function (this__5287__auto__,writer__5288__auto__,opt__5289__auto__){
return cljs.core._write(writer__5288__auto__,"reagent.impl.template/t_reagent$impl$template12212");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template12212.
 */
reagent.impl.template.__GT_t_reagent$impl$template12212 = (function reagent$impl$template$__GT_t_reagent$impl$template12212(opts,id,fn_to_element,parse_fn,meta12213){
return (new reagent.impl.template.t_reagent$impl$template12212(opts,id,fn_to_element,parse_fn,meta12213));
});
...
return (new reagent.impl.template.t_reagent$impl$template12212(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
