...
var G__9707 = devtools.prefs.pref(v);
v = G__9707;
continue;
} else {
return v;
...
}catch (e9654){var _e__8930__auto__ = e9654;
return false;
}})();
...
}catch (e9657){var _e__8930__auto__ = e9657;
return false;
}})();
...
}catch (e9661){var _e__8930__auto__ = e9661;
return false;
}}
}
});
...
var vec__9682 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9682,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9682,(1),null);
...
return cljs.core.some((function (p1__9685_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__9685_SHARP_);
}),template);
});
