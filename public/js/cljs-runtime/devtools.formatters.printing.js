...
var len__5726__auto___9399 = arguments.length;
var i__5727__auto___9400 = (0);
while(true){
if((i__5727__auto___9400 < len__5726__auto___9399)){
args__5732__auto__.push((arguments[i__5727__auto___9400]));

var G__9401 = (i__5727__auto___9400 + (1));
i__5727__auto___9400 = G__9401;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq9281){
...
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__9282,G__9283,seq9281__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__9335_SHARP_){
return (!((cljs.core.meta(p1__9335_SHARP_) == null)));
})))){
...
var map__9378 = opts;
var map__9378__$1 = cljs.core.__destructure_map(map__9378);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__9378__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e9379){var _e__8497__auto__ = e9379;
return false;
}})();
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
...
}catch (e9381){var _e__8497__auto__ = e9381;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__9389 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__9390 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__9390);
...
var map__9391 = opts;
var map__9391__$1 = cljs.core.__destructure_map(map__9391);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__9391__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__9389);
}});
...
var temp__5802__auto___9416 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5802__auto___9416)){
var managed_print_level_9417 = temp__5802__auto___9416;
var _STAR_print_level_STAR__orig_val__9394_9418 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__9395_9419 = managed_print_level_9417;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__9395_9419);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__9393_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__9393_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__9394_9418);
}} else {
job_fn();
}
