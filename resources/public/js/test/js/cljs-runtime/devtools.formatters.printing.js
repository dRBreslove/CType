...
var len__5726__auto___9862 = arguments.length;
var i__5727__auto___9864 = (0);
while(true){
if((i__5727__auto___9864 < len__5726__auto___9862)){
args__5732__auto__.push((arguments[i__5727__auto___9864]));

var G__9865 = (i__5727__auto___9864 + (1));
i__5727__auto___9864 = G__9865;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq9721){
var G__9722 = cljs.core.first(seq9721);
var seq9721__$1 = cljs.core.next(seq9721);
var G__9723 = cljs.core.first(seq9721__$1);
var seq9721__$2 = cljs.core.next(seq9721__$1);
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__9722,G__9723,seq9721__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__9739_SHARP_){
return (!((cljs.core.meta(p1__9739_SHARP_) == null)));
})))){
...
var map__9811 = opts;
var map__9811__$1 = cljs.core.__destructure_map(map__9811);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__9811__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e9818){var _e__8930__auto__ = e9818;
return false;
}})();
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
...
}catch (e9820){var _e__8930__auto__ = e9820;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__9830 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__9831 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__9831);
...
var map__9832 = opts;
var map__9832__$1 = cljs.core.__destructure_map(map__9832);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__9832__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__9830);
}});
...
var temp__5802__auto___9888 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5802__auto___9888)){
var managed_print_level_9889 = temp__5802__auto___9888;
var _STAR_print_level_STAR__orig_val__9842_9890 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__9843_9891 = managed_print_level_9889;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__9843_9891);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__9837_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__9837_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__9842_9890);
}} else {
job_fn();
}
