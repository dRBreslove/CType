...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_23771 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_23771(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_23772 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_23772(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_23773 = (function (reader,ch){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_23773(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_23774 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_23774(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_23775 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_23775(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_23776 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_23776(reader);
}
});
...
var G__23780 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__23781 = s.append(c);
c = G__23780;
s = G__23781;
continue;
}
