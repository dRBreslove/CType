...
var len__5726__auto___10789 = arguments.length;
var i__5727__auto___10790 = (0);
while(true){
if((i__5727__auto___10790 < len__5726__auto___10789)){
args__5732__auto__.push((arguments[i__5727__auto___10790]));

var G__10791 = (i__5727__auto___10790 + (1));
i__5727__auto___10790 = G__10791;
continue;
} else {
}
break;
...
var _STAR_print_newline_STAR__orig_val__10621_10792 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__10622_10793 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__10623_10794 = true;
var _STAR_print_fn_STAR__temp_val__10624_10795 = (function (x__5648__auto__){
return sb__5647__auto__.append(x__5648__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__10623_10794);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__10624_10795);

try{var _STAR_print_level_STAR__orig_val__10625_10796 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__10626_10797 = (300);
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__10626_10797);

try{cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.pprint.pprint,args);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__10625_10796);
}}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__10622_10793);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__10621_10792);
}
...
/** @this {Function} */
(devtools.util.pprint_str.cljs$lang$applyTo = (function (seq10618){
var self__5712__auto__ = this;
return self__5712__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq10618));
}));
...
var new_formatters = current_formatters.filter((function (p1__10652_SHARP_){
return (!(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(detector,p1__10652_SHARP_)));
}));
...
var G__10662_10810 = f;
var target__8471__auto___10811 = G__10662_10810;
if(cljs.core.truth_(target__8471__auto___10811)){
} else {
throw (new Error(["Assert failed: ",["unable to locate object path ",null," in ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__10662_10810)].join(''),"\n","target__8471__auto__"].join('')));
}

(target__8471__auto___10811["toString"] = (function (){
...
var G__10670_10813 = "%c%s";
var G__10671_10814 = "color:transparent";
var G__10672_10815 = devtools.util.make_detection_printer();
(f.cljs$core$IFn$_invoke$arity$3 ? f.cljs$core$IFn$_invoke$arity$3(G__10670_10813,G__10671_10814,G__10672_10815) : f.call(null, G__10670_10813,G__10671_10814,G__10672_10815));
...
var args__5732__auto__ = [];
var len__5726__auto___10821 = arguments.length;
var i__5727__auto___10822 = (0);
while(true){
if((i__5727__auto___10822 < len__5726__auto___10821)){
args__5732__auto__.push((arguments[i__5727__auto___10822]));

var G__10823 = (i__5727__auto___10822 + (1));
i__5727__auto___10822 = G__10823;
continue;
} else {
}
break;
...
var vec__10690 = devtools.util.feature_list_display(installed_features,feature_groups);
var fmt_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10690,(0),null);
var fmt_params = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10690,(1),null);
return devtools.util.wrap_with_custom_formatter_detection_BANG_((function() { 
var G__10824__delegate = function (add_fmt,add_args){
...
var G__10824 = function (add_fmt,var_args){
var add_args = null;
...
while (G__10825__i < G__10825__a.length) {G__10825__a[G__10825__i] = arguments[G__10825__i + 1]; ++G__10825__i;}
  add_args = new cljs.core.IndexedSeq(G__10825__a,0,null);
} 
return G__10824__delegate.call(this,add_fmt,add_args);};
G__10824.cljs$lang$maxFixedArity = 1;
G__10824.cljs$lang$applyTo = (function (arglist__10826){
var add_fmt = cljs.core.first(arglist__10826);
var add_args = cljs.core.rest(arglist__10826);
return G__10824__delegate(add_fmt,add_args);
});
...
/** @this {Function} */
(devtools.util.display_banner_BANG_.cljs$lang$applyTo = (function (seq10676){
...
var G__10679 = cljs.core.first(seq10676__$2);
var seq10676__$3 = cljs.core.next(seq10676__$2);
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__10677,G__10678,G__10679,seq10676__$3);
}));
...
var seq__10717 = cljs.core.seq(features);
var chunk__10718 = null;
var count__10719 = (0);
var i__10720 = (0);
while(true){
if((i__10720 < count__10719)){
var feature = chunk__10718.cljs$core$IIndexed$_nth$arity$2(null, i__10720);
...
var G__10833 = seq__10717;
var G__10834 = chunk__10718;
var G__10835 = count__10719;
var G__10836 = (i__10720 + (1));
seq__10717 = G__10833;
chunk__10718 = G__10834;
count__10719 = G__10835;
i__10720 = G__10836;
continue;
} else {
var temp__5804__auto__ = cljs.core.seq(seq__10717);
if(temp__5804__auto__){
var seq__10717__$1 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__10717__$1)){
var c__5525__auto__ = cljs.core.chunk_first(seq__10717__$1);
var G__10837 = cljs.core.chunk_rest(seq__10717__$1);
var G__10838 = c__5525__auto__;
var G__10839 = cljs.core.count(c__5525__auto__);
var G__10840 = (0);
seq__10717 = G__10837;
chunk__10718 = G__10838;
count__10719 = G__10839;
i__10720 = G__10840;
continue;
} else {
var feature = cljs.core.first(seq__10717__$1);
if(cljs.core.not(cljs.core.some(cljs.core.PersistentHashSet.createAsIfByAssoc([feature]),known_features))){
devtools.context.get_console.call(null, ).warn(devtools.util.unknown_feature_msg.call(null, feature,known_features,lib_info));
} else {
}
...
var G__10841 = cljs.core.next(seq__10717__$1);
var G__10842 = null;
var G__10843 = (0);
var G__10844 = (0);
seq__10717 = G__10841;
chunk__10718 = G__10842;
count__10719 = G__10843;
i__10720 = G__10844;
continue;
}
} else {
...
if(cljs.core.truth_(temp__5802__auto__)){
var o10768 = temp__5802__auto__;
return (o10768["version"]);
} else {
return null;
}
})() == null);
