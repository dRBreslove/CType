...
var G__9257 = devtools.prefs.pref(v);
v = G__9257;
continue;
} else {
return v;
...
}catch (e9195){var _e__8497__auto__ = e9195;
return false;
}})();
...
}catch (e9200){var _e__8497__auto__ = e9200;
return false;
}})();
...
}catch (e9202){var _e__8497__auto__ = e9202;
return false;
}}
}
});
...
var vec__9226 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9226,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9226,(1),null);
...
return cljs.core.some((function (p1__9241_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__9241_SHARP_);
}),template);
});
