...
var len__5726__auto___13400 = arguments.length;
var i__5727__auto___13401 = (0);
while(true){
if((i__5727__auto___13401 < len__5726__auto___13400)){
args__5732__auto__.push((arguments[i__5727__auto___13401]));

var G__13403 = (i__5727__auto___13401 + (1));
i__5727__auto___13401 = G__13403;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq13270){
...
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__13271,G__13272,seq13270__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__13329_SHARP_){
return (!((cljs.core.meta(p1__13329_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13362__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e13366){var _e__12659__auto__ = e13366;
return false;
}})();
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
...
}catch (e13369){var _e__12659__auto__ = e13369;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__13375 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__13376 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__13376);
...
var map__13377 = opts;
var map__13377__$1 = cljs.core.__destructure_map(map__13377);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13377__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__13375);
}});
...
var temp__5802__auto___13468 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5802__auto___13468)){
var managed_print_level_13469 = temp__5802__auto___13468;
var _STAR_print_level_STAR__orig_val__13383_13470 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__13384_13471 = managed_print_level_13469;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__13384_13471);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__13380_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__13380_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__13383_13470);
}} else {
job_fn();
}
