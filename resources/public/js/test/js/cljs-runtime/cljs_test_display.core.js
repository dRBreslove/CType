...
var node = (function (){var G__12719 = new cljs.core.Keyword(null,"style","style",-496642736);
var G__12720 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"id","id",-1388402092),"cljs-test-display-style"], null);
var G__12721 = style_string_12892;
return (cljs_test_display.core.n.cljs$core$IFn$_invoke$arity$3 ? cljs_test_display.core.n.cljs$core$IFn$_invoke$arity$3(G__12719,G__12720,G__12721) : cljs_test_display.core.n.call(null, G__12719,G__12720,G__12721));
})();
...
var len__5726__auto___12894 = arguments.length;
var i__5727__auto___12895 = (0);
while(true){
if((i__5727__auto___12895 < len__5726__auto___12894)){
args__5732__auto__.push((arguments[i__5727__auto___12895]));

var G__12896 = (i__5727__auto___12895 + (1));
i__5727__auto___12895 = G__12896;
continue;
} else {
}
break;
...
return cljs_test_display.core.n.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__5733__auto__);
});
...
/** @this {Function} */
(cljs_test_display.core.n.cljs$lang$applyTo = (function (seq12722){
...
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12723,G__12724,seq12722__$2);
}));
...
var vec__12765 = ((clojure.string.starts_with_QMARK_(cljs.core.first(classes),"#"))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$2(cljs.core.first(classes),(1)),cljs.core.rest(classes)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,classes], null));
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12765,(0),null);
var classes__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12765,(1),null);
var G__12770 = cljs.core.PersistentArrayMap.EMPTY;
var G__12770__$1 = (cljs.core.truth_(id)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__12770,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__12770);
if(cljs.core.truth_(cljs.core.not_empty(classes__$1))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__12770__$1,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.cljs$core$IFn$_invoke$arity$2(" ",classes__$1));
} else {
return G__12770__$1;
}
} else {
...
return (function() { 
var G__12898__delegate = function (klass,contents){
var vec__12774 = (((klass instanceof cljs.core.Keyword))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [klass,contents], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,cljs.core.cons(klass,contents)], null));
var klass__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12774,(0),null);
var contents__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12774,(1),null);
...
var G__12898 = function (klass,var_args){
var contents = null;
if (arguments.length > 1) {
var G__12899__i = 0, G__12899__a = new Array(arguments.length -  1);
while (G__12899__i < G__12899__a.length) {G__12899__a[G__12899__i] = arguments[G__12899__i + 1]; ++G__12899__i;}
  contents = new cljs.core.IndexedSeq(G__12899__a,0,null);
} 
return G__12898__delegate.call(this,klass,contents);};
G__12898.cljs$lang$maxFixedArity = 1;
G__12898.cljs$lang$applyTo = (function (arglist__12903){
var klass = cljs.core.first(arglist__12903);
var contents = cljs.core.rest(arglist__12903);
return G__12898__delegate(klass,contents);
});
...
cljs_test_display.core.process_file_name = (function cljs_test_display$core$process_file_name(p__12779){
var map__12780 = p__12779;
var map__12780__$1 = cljs.core.__destructure_map(map__12780);
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12780__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12780__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
cljs_test_display.core.comparison = (function cljs_test_display$core$comparison(p__12839){
var map__12840 = p__12839;
var map__12840__$1 = cljs.core.__destructure_map(map__12840);
var actual = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12840__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
var expected = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12840__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
...
cljs_test_display.core.error_comparison = (function cljs_test_display$core$error_comparison(p__12843){
var map__12844 = p__12843;
var map__12844__$1 = cljs.core.__destructure_map(map__12844);
var expected = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12844__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
var actual = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12844__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
...
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(cljs_test_display.core.state,cljs.core.update,new cljs.core.Keyword(null,"current-node","current-node",-814308842),(function (p1__12850_SHARP_){
return cljs.core.cons(new_current_node,p1__12850_SHARP_);
}));
...
var curr_node = cljs_test_display.core.current_node();
var map__12852 = cljs_test_display.core.current_var_info();
var map__12852__$1 = cljs.core.__destructure_map(map__12852);
var info = map__12852__$1;
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12852__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12852__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12852__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(cljs_test_display.core.state,cljs.core.update,new cljs.core.Keyword(null,"current-node","current-node",-814308842),(function (p1__12851_SHARP_){
return cljs.core.cons(node,p1__12851_SHARP_);
}));

return goog.dom.appendChild(curr_node,node);
});
cljs_test_display.core.summary = (function cljs_test_display$core$summary(p__12853){
var map__12854 = p__12853;
var map__12854__$1 = cljs.core.__destructure_map(map__12854);
var m = map__12854__$1;
var fail = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12854__$1,new cljs.core.Keyword(null,"fail","fail",1706214930));
var error = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12854__$1,new cljs.core.Keyword(null,"error","error",-978969032));
var pass = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12854__$1,new cljs.core.Keyword(null,"pass","pass",1574159993));
var test = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12854__$1,new cljs.core.Keyword(null,"test","test",577538877));
...
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["expected:",(function (){var G__12868 = new cljs.core.Keyword(null,"expected","expected",1583670997).cljs$core$IFn$_invoke$arity$1(m);
return (formatter_fn.cljs$core$IFn$_invoke$arity$1 ? formatter_fn.cljs$core$IFn$_invoke$arity$1(G__12868) : formatter_fn.call(null, G__12868));
})()], 0));

return cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["  actual:",(function (){var G__12869 = new cljs.core.Keyword(null,"actual","actual",107306363).cljs$core$IFn$_invoke$arity$1(m);
return (formatter_fn.cljs$core$IFn$_invoke$arity$1 ? formatter_fn.cljs$core$IFn$_invoke$arity$1(G__12869) : formatter_fn.call(null, G__12869));
})()], 0));
});
...
var temp__5804__auto___12905 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5804__auto___12905)){
var message_12906 = temp__5804__auto___12905;
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([message_12906], 0));
} else {
}
...
var temp__5804__auto___12907 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5804__auto___12907)){
var message_12908 = temp__5804__auto___12907;
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([message_12908], 0));
} else {
}
